...
public class T5Reducer extends Reducer<Text, Text, Text, Text> {
    ...
    // Counter for the number of tweets where predicted sentiment matches the actual sentiment
    private int totalMatches = 0;
    // Logger for logging information about the processing
    final Log LOG = LogFactory.getLog(T5Reducer.class);

    // Setup method is called once at the beginning of the task and is used to initialize resources.
    @Override
    ...
    // The reduce method is called for each key and its list of values. Here, it processes each tweet and its sentiment.
    @Override
    protected void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
        ...
        for (Text value : values) {
            ...
            // If the predicted sentiment matches the actual sentiment, increment the total matches counter
    ...
    // The cleanup method is called once at the end of the task and is used for cleanup and to write final output.
    @Override
    protected void cleanup(Context context) throws IOException, InterruptedException {
        // Calculate the accuracy of sentiment prediction matches as a value between 0 and 1
